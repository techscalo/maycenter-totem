...
const SECCIONES: Sec[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "Si el paciente llega sin turno (urgencia, orden de llegada), tildá 'Sin turno (ST)' en vez de poner una hora: el turno se muestra con la etiqueta 'ST' y se ordena por su hora de llegada.",
      "En los turnos cargados a mano también podés marcar la Ficha (Tiene ficha / No tiene ficha) desde su columna, igual que en los de GHL.",
    ],
    notas: [
      "Dos horas distintas: 'Hora llegada' es cuando el paciente entró a la clínica (check-in del tótem, o el momento en que cargás el turno manual); 'Ingreso a sala' es cuando pasó al box de atención (al marcar 'En sala').",
      "En un turno cargado a mano la 'Hora llegada' queda registrada al momento de cargarlo (el paciente ya está presente); no cambia al marcar 'Finalizado'.",
      "'Sin turno (ST)': para pacientes que se atienden por orden de llegada. No exige horario y se atienden según prioridad de la recepción.",
